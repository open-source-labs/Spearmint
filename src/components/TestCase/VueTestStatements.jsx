...
import Action from '../VueTestComponent/Action/Action';
import Assertion from '../VueTestComponent/Assertion/Assertion';
import Render from '../VueTestComponent/Render/Render';
...
export default VueTestStatements;
