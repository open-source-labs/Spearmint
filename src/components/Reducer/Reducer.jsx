        ...
        >
          ...
          <div id={styles.reducerNameFlexBox}>
            ...
            <div id={styles.reducerName}>
              ...
              <SearchInput options={Object.keys(filePathMap)} dispatch={dispatchToReduxTestCase} filePathMap={filePathMap} updateTypesFilePath={updateTypesFilePath}  id={reducer.id}/>
            </div>
          </div>
          <div id={styles.reducerNameFlexBox}>
            <div id={styles.reducerName}>
