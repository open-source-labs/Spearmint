...
import { addRenderProp, deleteRenderProp, updateRenderProp } from '../../../context/testCaseActions'
...
const RenderProp = ({ dispatchTestCase, renderId, propId, propKey, propValue }) => {
  ...
  return (
    <div>
      <h4>Props</h4>
      <FontAwesomeIcon id='delete-action' icon='plus' onClick={handleClickAdd} />
      <p>key</p>
      <p>value</p>
      <FontAwesomeIcon id='delete-action' icon='minus' onClick={handleClickDelete} />
