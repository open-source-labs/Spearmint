...
interface EventType {
  ...
  export const cypressQueryActionTypesList: Array<EventType> = [

    { name: 'click', description: '.' },
    { name: 'dblclick', description: '.' },
    { name: 'rightclick', description: '.' },
    { name: 'type', description: '.' },
    { name: 'clear', description: '.' },
    { name: 'check', description: '.' },
    { name: 'uncheck', description: '.' },
    { name: 'select', description: '.' },
    { name: 'trigger', description: '.' },
    { name: 'selectFile', description: '.' },
  ];
