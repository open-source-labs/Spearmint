...
import { RenderProps, VisitProps } from '../../../utils/reactTypes';
...
const handleUpdateVisitKey = (e: React.ChangeEvent<HTMLInputElement>): void => {
  const newKey = e.target.value;
  setVisitKey(newKey); // passing value
  dispatchToReactTestCase(updateRenderUrl(statementId, visitId, newKey, visitValue || ''));
...
const handleUpdateVisitValue = (e: React.ChangeEvent<HTMLInputElement>): void => {
