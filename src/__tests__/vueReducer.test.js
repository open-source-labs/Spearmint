import { vueTestCaseReducer, vueTestCaseState } from '../context/reducers/vueTestCaseReducer';

describe('Vue Reducer', () => {
  let initialState = {};
  ...
  it('should return the initial state', () => {
    expect(vueTestCaseReducer(initialState, {})).toEqual(initialState);
  });

  it('should handle TOGGLE_VUE', () => {
    expect(
      vueTestCaseReducer(initialState, { type: 'TOGGLE_VUE' })
    ).toEqual({
      ...initialState,
    });
  });
  ...
  it('should handle ADD_DESCRIBE_BLOCK', () => {
    expect(
      vueTestCaseReducer(initialState, { type: 'ADD_DESCRIBE_BLOCK' })
    ).toEqual({
      ...initialState,
      describeId: 2,
      describeBlocks: {
  ...
  it('should handle UPDATE_DESCRIBE_TEXT', () => {
    ...
    expect(vueTestCaseReducer(initialState, action)).toEqual({
      ...initialState,
      describeBlocks: {
