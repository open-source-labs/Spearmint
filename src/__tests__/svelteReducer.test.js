import { SvelteTestCaseReducer, svelteTestCaseState } from '../context/reducers/svelteTestCaseReducer';

describe('Svelte Reducer', () => {
  let initialState = {};
  ...
  it('should return the initial state', () => {
    expect(SvelteTestCaseReducer(initialState, {})).toEqual(initialState);
  });

  it('should handle TOGGLE_SVELTE', () => {
    expect(
      SvelteTestCaseReducer(initialState, { type: 'TOGGLE_SVELTE' })
    ).toEqual({
      ...initialState,
    });
  });
  ...
  it('should handle ADD_DESCRIBE_BLOCK', () => {
    expect(
      SvelteTestCaseReducer(initialState, { type: 'ADD_DESCRIBE_BLOCK' })
    ).toEqual({
      ...initialState,
      describeId: 2,
      describeBlocks: {
  ...
  it('should handle UPDATE_DESCRIBE_TEXT', () => {
    ...
    expect(SvelteTestCaseReducer(initialState, action)).toEqual({
      ...initialState,
      describeBlocks: {
