import { SolidTestCaseReducer, solidTestCaseState } from '../context/reducers/solidTestCaseReducer';

describe('Solid Reducer', () => {
  let initialState = {};
  ...
  it('should return the initial state', () => {
    expect(SolidTestCaseReducer(initialState, {})).toEqual(initialState);
  });

  it('should handle TOGGLE_SOLID', () => {
    expect(
      SolidTestCaseReducer(initialState, { type: 'TOGGLE_SOLID' })
    ).toEqual({
      ...initialState,
    });
  });
  ...
  it('should handle ADD_DESCRIBE_BLOCK', () => {
    expect(
      SolidTestCaseReducer(initialState, { type: 'ADD_DESCRIBE_BLOCK' })
    ).toEqual({
      ...initialState,
      describeId: 2,
      describeBlocks: {
  ...
  it('should handle UPDATE_DESCRIBE_TEXT', () => {
    ...
    expect(SolidTestCaseReducer(initialState, action)).toEqual({
      ...initialState,
      describeBlocks: {
