...
import { actionTypes } from '../actions/vueTestCaseActions';

export const VueTestCaseContext = createContext([]);

export const vueTestCaseState = {
  modalOpen: false,
...
/* ------------------------- Vue Test Case Reducer ------------------------ */

export const vueTestCaseReducer = (state, action) => {
  Object.freeze(state);
