export const actionTypes = {
    UPDATE_STATEMENTS_ORDER: 'UPDATE_REDUX_STATEMENTS_ORDER',
  ...
  export const updateReduxStatementsOrder = draggableStatements => ({
    type: actionTypes.UPDATE_REDUX_STATEMENTS_ORDER,
    draggableStatements,
  });
  
  export const updateReduxTestStatement = testStatement => ({
