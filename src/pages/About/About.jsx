    ...
    <>
      <div id={styles.container}>
        <article class='markdown-body entry-content container-lg' itemprop='text'>
          ...
          <p>
            To run React tests generated by spearmint, install the following in your dev
            dependencies.
          </p>
          <pre>
            <code>
          ...
          <p>
            To run Redux tests generated by spearmint, install the following in your dev
          ...
          <ol>
            <li>
              On the initial screen, enter the URL of your project and load your application to
          ...
          <p>
            <img src={image1} alt='' style={{ 'max-width': '50%' }} />
          </p>
          <ol start='3'>
            <li>
              <p>
                Refer to the browser view of your app that is displayed on the right to quickly
                identify values for your selectors and use the file directory to open up a code
                editor view to easily refer to your codebase for props information.
              </p>
            </li>
            <li>
              <p>
          ...
          <p>
            <img src={image2} alt='' style={{ 'max-width': '50%' }} />
          </p>
          <h2>Team</h2>
          <hr></hr>
          <blockquote>
      ...
      <button id={styles.helpBtn} onClick={handleChangeBack}>
